module "jenkins_ecr_build_terraform_v13_repository" {
  ...
  policy_variables = { role_arn = module.jenkins_build_terraform_v13_execution_role.role.arn }
}
...
module "jenkins_build_terraform_v13_execution_role" {
  ...
  policy_attachments = { ecr_policy = module.jenkins_build_terraform_v13_execution_policy.policy_arn }
}
