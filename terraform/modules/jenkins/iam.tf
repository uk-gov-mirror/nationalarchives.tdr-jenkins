...
data "aws_iam_policy_document" "jenkins_fargate_policy_document" {
  ...
  statement {
    ...
    resources = [
      ...
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/TDRJenkinsRunSsmRoleIntg",
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/TDRJenkinsRunSsmRoleStaging",
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/TDRJenkinsRunSsmRoleProd",
      "arn:aws:iam::${data.aws_caller_identity.current.account_id}:role/TDRJenkinsCheckAmiRole",
